      ...
      <Layout>
        <main className="main-content min-h-screen pt-24 px-8 pb-12 flex flex-col justify-center items-center font-sans">
          ...
          <p className="text-xs text-slate-500 font-semibold tracking-wide uppercase">
            Assembling Workspace Intelligence...
          </p>
        </main>
      </Layout>
    );
        ...
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="bg-white border border-[#E5E7EB] rounded-2xl p-6 shadow-sm flex flex-col justify-between h-40 hover:shadow-md transition-all duration-300"
              >
                <div className="space-y-1">
                  <span className="text-[10px] text-[#6B7280] font-bold uppercase tracking-wider block">
                    {metric.label}
                  </span>
                  <span className={`text-3xl font-extrabold ${metric.color} tracking-tight`}>
                    {metric.value}
                  </span>
                </div>
                <div className="flex items-center justify-between border-t border-slate-50 pt-3">
                  ...
                  {/* Micro Trend Curve */}
                  <svg
                    className="w-16 h-8 stroke-indigo-600/40 fill-none stroke-2"
                    viewBox="0 0 100 30"
                  >
                ...
                <div className="p-6 flex items-center justify-between border-b border-[#E5E7EB]">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-[#6B7280]">
                      Click a call row to inspect live summaries and recordings
                    </p>
                  </div>
                  <Link
                    href="/calls"
                    ...
                    <tbody>
                      {recentCalls.length > 0 ? (
                              ...
                              >
                                ...
                                >
                                  <button
                                    ...
                                    aria-label={
                                      call.isFavorite ? 'Remove from favorites' : 'Add to favorites'
                                    }
                                    title={
                                      call.isFavorite ? 'Remove from favorites' : 'Add to favorites'
                                    }
                        ...
                        <tr>
                          <td
                            colSpan={6}
                            className="py-12 text-center text-slate-400 font-semibold uppercase text-[10px]"
                          >
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white border border-[#E5E7EB] rounded-2xl p-6 shadow-sm space-y-6">
                ...
                <div className="space-y-4">
                  {notifications.length > 0 ? (
                    ...
                    <p className="text-[10px] text-slate-400 text-center py-4 font-semibold uppercase">
                      No active workspace alerts.
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="bg-gradient-to-tr from-indigo-600 to-[#4338CA] text-white rounded-2xl p-6 space-y-4 shadow-md">
                ...
                <p className="text-xs leading-relaxed font-medium">
                  🎯 Acme Corp has expressed concern over HubSpot CRM custom mappings. Use our
                  pre-built bi-directional workflow templates to qualify timelines automatically.
                </p>
                <div className="pt-2">
                  <Link
                    href="/settings"
